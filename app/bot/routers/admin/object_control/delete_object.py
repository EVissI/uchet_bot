...
delete_object_router = Router()

@delete_object_router.message(F.text.in_(get_all_texts('delete_object_btn')), StateFilter(AdminPanelStates.objects_control),UserInfo())
