...
TEXTS_TRANSLITE = {
    ...
    "check_type_object_btn": "Учет чеков по объектам",
    "check_type_general_btn": "Учет чеков вне объектов",
...
После создания username нажмите кнопку "Проверить" ниже.""",
        ...
        "send_check_photo_and_description": "📸 Отправьте фото и описание чека в одном сообщении",
        ...
        'material_order_view': "Просмотр заказов материалов",
        ...
        "manual_input_prompt": "Введите сумму чека",
        'manual_input_error_amount': "❌ Ошибка при вводе суммы. Пожалуйста, введите число.",
        'manual_input_success': "✅ Сумма успешно сохранена",
        "upload_without_documents_btn": "Загрузить без документов",
        ...
        "check_created":"✅ Чек успешно создан и сохранён.",
        ...
        "select_tools_status": "Выберите статус инструмента для выгрузки",
        ...
        "check_own_expense_true_btn": "За свой счет",
        "check_own_expense_false_btn": "За счет компании",
        "check_description_required": "Пожалуйста, введите описание чека:",
        "enter_new_photo": "📸 Отправьте новое фото",
        "check_own_expense_required": "❗️ Пожалуйста, укажите, за чей счет чек",
        ...
        "create_object_documents": "📸 Загрузите фотографии или pdf документов по объекту.\n\nКогда загрузите все документы, нажмите 'Прекратить'",
        ...
        "tools_export_error":"Ошибка экспорта инструмента",
        "excel_tool_owner":"Инструмент привязан за",
        "yes_btn": "✅ Да",
        "no_btn": "❌ Нет",
