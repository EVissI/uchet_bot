...
После создания username нажмите кнопку "Проверить" ниже.""",
        ...
        "choose_reminder": "Выберите материал:",
        ...
        "material_remainder_control_btn": "📦 Управление остатками",
        ...
        "change_reminder_btn": "✏️ Изменить напоминание",
        "deactivate_reminder_btn": "❌ Деактивировать напоминание",
        "create_material_reminder_btn": "➕ Создать напоминание",
