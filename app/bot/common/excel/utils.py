...
from app.db.models import ObjectCheck
...
def create_expense_report(expenses: list[ObjectCheck], lang: str) -> io.BytesIO:
    ...
    for row, expense in enumerate(expenses, 2):
        ...
        ws.cell(row=row, column=5, value=get_text("own_expense", lang) if expense.is_own_expense else get_text("company_expense", lang))
